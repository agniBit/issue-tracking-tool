...
function ShowOptions(props: any) {
  return (
    <div className='options'>
      {props.options.map((optionData: { option: string, icon: string}, i: number) => {
        return (
...
function AddIssue(prop:any) {
  ...
  const optionData = {
    assignee: [],
    priority: [{ option: 'High', icon:'high_.png' }, { option: 'Medium', icon:'mid_.png' }, { option: 'Low', icon:'low_.png' }],
        ...
        <div className='new_issue_container' ref={ref}>
          <div className='new_issue_form'>
            ...
            <div className='select_options'>
              ...
              <SelectButton name='priority' image='/assets/priority2.png' text='priority' list={optionData.priority}/>
